        ...
        <Card className="w-full h-full p-8">
            ...
            <CardContent className="space-y-5 px-0 pb-0">
                ...
                <div className="flex flex-col gap-y-2.5">
                    ...
                    <Button variant="outline" className="w-full relative" size="lg" onClick={() => OnProviderSignIn("google")} disabled={pending}> 
                        <FcGoogle className="size-5 absolute left-2.5 top-2.5 "/>    
                        Continue with Google
                    </Button>
                    <Button variant="outline" className="w-full relative" size="lg" onClick={() => OnProviderSignIn("github")} disabled={pending}> 
